<template>
	<div class="xiaoZhan">
		<div class="searchBar">
			...
			<el-date-picker v-model="info.recvEndTime" id="begin" class="picker words" type="datetime" :clearable="false" :editable="false"
			...
			<div class="MX_dialog">
				<li>
					...
					<div class="left">
						...
						<input v-model="ekeyInfo.userID1" id="userID1" disabled autocomplete="off"/>
					</div>
				</li><li>
					<div class="left">
						<p class="txt">{{$t('fbcsFile.order.ekeyOrder.userName')}}</p>
					</div><div class="right">
						<input v-model="ekeyInfo.userName1" id="userName1" disabled autocomplete="off"/>
					</div>
				</li><li>
					<div class="left">
						<p class="txt">{{$t('fbcsFile.order.signalOrder.toUserID')}}</p>
					</div><div class="right">
						<input v-model="ekeyInfo.userID2" id="userID2" disabled autocomplete="off"/>
					</div>
				</li><li>
					<div class="left">
						<p class="txt">{{$t('fbcsFile.order.signalOrder.toUserName')}}</p>
					</div><div class="right">
						<input v-model="ekeyInfo.userName2" id="userName2" disabled autocomplete="off"/>
					</div>
				</li><li>
					<div class="left">
						<p class="txt">
						...
						<el-select v-model="ekeyInfo.bizType" id="type">
