<template>
	<div class="hello">
		<img src="@/fbcsFxViews/img/logo.png">
		<h1>{{ msg }}</h1>
...
<style scoped>
	.hello { font-family: 'Avenir', Helvetica, Arial, sans-serif; -webkit-font-smoothing: antialiased;text-align: center;
		-moz-osx-font-smoothing: grayscale; color: #2c3e50; margin-top: 60px; }
